								...
								<div class="card">
									...
									<div class="row">
										<div class="col-12">
											...
											<?php 
											$no=1;
											foreach($listoutbox as $ibx):?>							
											<tbody>
											<tr role="row" class="odd">
											<td><?php echo $no++ ?></td>
												<td><?php echo $ibx->Nomor_surat ?></td>
												<td><?php echo $ibx->Nama ?></td>
												<td><?php echo $ibx->Judul_surat ?></td>
												<td><?php echo strip_tags($ibx->Isi_surat) ?></td>
												<td><?php echo $ibx->Tanggal_surat ?></td>
												<td><a href="#" class="btn btn-sm btn-warning" >Detail</a>&nbsp;<a href="#" class="btn btn-sm btn-warning" data-toggle="modal" data-animation="bounce" data-target=".compose-modal" >Balas</a></td>
											</tr>
											</tbody>
											<?php endforeach; ?>
											</table>
